...
class OrangeHRMLocators:
    ...
    admin_menu_locator = '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[1]' 
    pim_menu_locator = '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[2]' 
    leave_menu_locator = '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[3]' 
    time_menu_locator = '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[4]' 
    recruitment_menu_locator = '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[5]' 
    my_info_menu_locator = '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[6]' 
    performance_menu_locator = '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[7]' 
    dashboard_menu_locator = '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[8]' 
